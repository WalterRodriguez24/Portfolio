  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        ...
        >
          ...
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sn xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16"
          >
            I am an experienced web developer dedicated to creating high-quality
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg img */}
        <div
          className="bg-none xl:bg-explosion xl:bg-right xl:bg-no-repeat w-full h-full
